...
from tools import reg_net
from tools import vreg_net
from tools import vcyl_net
from tools import up_net
...
def main():
    ...
    elif args.reg_model == True:
        reg_net(args, config, train_writer, val_writer)
    elif args.vreg_model == True:
        vreg_net(args, config, train_writer, val_writer)
    elif args.vcyl_model == True:
        vcyl_net(args, config, train_writer, val_writer)
    elif args.up_model == True:
        up_net(args, config, train_writer, val_writer)
    else:
